...
const SoundLightingForm = () => {
  ...
  return (
    <div
      style={{backgroundImage: `url(${require('../Assets/BGlight.webp')})`, backgroundSize: 'cover', height: '100vh', backgroundPosition: 'center', opacity: '1'}}
    >
    <Box sx={{ p: 3, maxWidth: 900, mx: 'auto' }}>
      <Box mt={5}
         sx={{backgroundColor:'#eee', mt:5, borderRadius:'20px', opacity:'0.88', fontWeight:'bold'}}>
      <Typography
        variant="h4"
        align='center'
        p={5}
