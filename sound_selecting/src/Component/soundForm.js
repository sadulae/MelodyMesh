...
import { TextField, Button, Select, MenuItem, FormControl, InputLabel, Checkbox, ListItemText, OutlinedInput, Grid, Box, Typography } from '@mui/material';
...
const SoundLightingForm = () => {
  ...
  return (
    <div
      style={{backgroundImage: `url(${require('../Component/mic.jpg')})`, backgroundSize: 'cover', height: '100vh', backgroundPosition: 'center', opacity: '0.8'}}
    >
